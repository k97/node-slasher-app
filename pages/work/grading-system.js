...
class GradingSystem extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout title={`Emirates Grading - Karthik`}>
        <div className='body-content'>

          <ProjectTitle heading="Emirates Grading" date="October, 2016" bgColor="bg-air" />
