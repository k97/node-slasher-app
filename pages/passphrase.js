  ...
  render() {
    return (
      <Layout title={"Passphrase"}>
        ...
        <div className="mt2 body-content">
          ...
          <section className="mw5 mw7-ns center bg-white pa3 ph5-ns br2 ba b--black-10">
            ...
            <form className="db w-100 passphrase-form" onSubmit={(e) => this.onSubmitPass(e)}>
              ...
              <button className="input-reset w-100 w-auto-ns bg-blue f2 ph4" type="submit">
                <i className="ion-ios-arrow-thin-right white  v-mid k-icon-arrow"></i>
              </button>
            </form>
            ...
            <div className="lh-copy mt3 mb4 black-60">
              <small className="f6">
                ...
                <a className="ka-link dim"  href="mailto:karthik97live@icloud.com?subject=Access to K97 Portfolio">Drop me a message here,</a> to recieve the passphrase.
            </small>
            </div>
